<%@ Page Title="Chỉnh sửa" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SuaHoSo.aspx.cs" Inherits="CongNghePhanMem.view.SuaHoSo" %>
   ...
   <style type="text/css">
     ...
     <div class="login-container">
        ...
        <div class="button-container">
            <asp:Button ID="submit" runat="server" Text="Thêm bài báo" OnClientClick="return ValidateForm();" OnClick="Button1_Click" CssClass="centered-button" />
        </div>
        </div>
