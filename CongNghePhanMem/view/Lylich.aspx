<%@ Page Title="Lý lịch" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Lylich.aspx.cs" Inherits="CongNghePhanMem.view.Lylich" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1 style="font-size: x-large; text-align: center;">Lý lịch khoa học</h1>
    <p>
        <br />
        Họ và tên:
